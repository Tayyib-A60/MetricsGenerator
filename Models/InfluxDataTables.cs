...
{
    public class InfluxDataTables
    {
        public const string FundsTransferInitiatedTable = "FundsTransferInitiatedTable";
        public const string FundsTransferProcessedTable = "FundsTransferProcessedTable";
        public const string NameInquiryInitiatedTable = "NameInquiryInitiatedTable";
